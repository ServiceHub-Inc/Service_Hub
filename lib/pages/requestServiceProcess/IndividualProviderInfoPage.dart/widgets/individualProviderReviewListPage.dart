...
import 'attachedfiles_individual/reviewTile_individual.dart';

class IndividualProviderReviewListPage extends StatelessWidget {
  // build list function

  List _buildList(int count) {
    List<Widget> listItems = [];
    for (int i = 0; i < count; i++) {
      listItems.add(ReviewTileIndividual());
    }
    return listItems;
  }
